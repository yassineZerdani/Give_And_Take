...
import com.example.give_and_take.databinding.ActivityUpdateMyServiceBinding;
...
public class UpdateMyServiceActivity extends AppCompatActivity {
    ...
    private ActivityUpdateMyServiceBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUpdateMyServiceBinding.inflate(getLayoutInflater());
    ...
    private void setListeners(){
        binding.updateService.setOnClickListener(v -> {
            ...
            binding.textUpdateImage.setOnClickListener(d -> {
    ...
    private void updateService(){
        ...
        database.collection(Constants.KEY_COLLECTION_SERVICES).document(Constants.KEY_SERVICE).update(service).addOnSuccessListener(documentReference -> {
                ...
                if(result.getResultCode() == RESULT_OK){
                    if(result.getData() != null){
                        ...
                        try{
                            ...
                            binding.textUpdateImage.setVisibility(View.GONE);
