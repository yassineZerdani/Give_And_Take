...
import com.example.give_and_take.databinding.UsersContainerBinding;
import com.example.give_and_take.listeners.UserListener;
import com.example.give_and_take.models.User;

import java.util.List;

public class UsersController extends RecyclerView.Adapter<UsersController.UserViewHolder> {

    private final List<User> users;
    private final UserListener userListener;

    public UsersController(List<User> users, UserListener userListener) {
        this.users = users;
