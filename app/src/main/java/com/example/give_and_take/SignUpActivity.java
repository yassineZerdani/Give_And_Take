...
import com.example.give_and_take.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp(){
        ...
        user.put(Constants.KEY_NAME, binding.nameSignup.getText().toString());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS).add(user).addOnSuccessListener(documentReference -> {
            ...
            preferenceManager.putString(Constants.KEY_NAME, binding.nameSignup.getText().toString());
    ...
    private Boolean isValidSignUpDetails(){
        ...
        else if(binding.nameSignup.getText().toString().trim().isEmpty()){
